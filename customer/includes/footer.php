<footer class="page-footer">
	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				<div class="email">
					Email:
					<a href="mailto:support@yourwebsite.com" class="email__addr">IDEALBITS@HKBK.EDU.IN</a>
				</div>
			</div>
	...
	<div class="page-footer__subline">
		...
		<div class="developer">
          ...
          <div class="designby">
            Design by :- <br>Swati Shrikant Santolli<br>Samreen Hunagund <br> Sahana S <br> Syed Abdul Rehman<br>Syed Maaz
          </div>
		</div>
	</div>
</footer>
